      ...
      <section id="aboutme" className="my-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-8 md:mx-10">
          ...
          <div className="bg-gray-100 md:rounded-lg p-4 md:w-96 text-sm justify-self-center md:justify-self-auto shadow">
            ...
            experience building efficient and scalable applications, with a
            strong focus on frontend development. I’m passionate about
            optimizing performance and ensuring smooth user experiences, and I
            frequently use unit testing to maintain code quality and
            reliability. In my free time, I explore new tech tools to enhance my
            skills and improve the scalability of the systems I build. Being a
            developer can be challenging, so I take breaks by walking, snacking,
            or playing video games to recharge.
          </div>
        </div>
      </section>
    </>
